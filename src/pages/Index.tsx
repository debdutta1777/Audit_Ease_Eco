...
function ScrollReveal({
  ...
  const visibleClass =
    direction === "left" || direction === "right" ? "scroll-visible-x" :
  ...
  return (
    <div
      ref={ref}
      className={`${hiddenClass} ${inView ? visibleClass : ""} ${className}`}
...
const Index = () => {
  ...
  // Separate inView trackers for count-up stats
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        {/* Hero Section */}
        <main className="relative flex flex-1 flex-col items-center justify-center px-6 pb-8 pt-28 text-center lg:pt-36">
          {/* Badge */}
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {[
                ...
                <ScrollReveal key={feature.title} delay={i * 150}>
                  <div
                    className="group relative overflow-hidden rounded-2xl border border-emerald-500/20 bg-slate-900/50 p-8 backdrop-blur-md transition-all duration-300 hover:border-emerald-400/50 hover:bg-slate-900/70 h-full"
                  >
          ...
          <div className="mx-auto max-w-5xl">
            <ScrollReveal direction="scale">
              <div
                ...
                className="rounded-3xl border border-emerald-500/20 bg-gradient-to-br from-slate-900/80 to-slate-800/50 p-8 backdrop-blur-md sm:p-12"
              >
                <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
                  {[
                    { value: 99.2, label: "Accuracy Rate", suffix: "%", decimals: 1 },
                    { value: 60, label: "Second Analysis", suffix: "s", decimals: 0 },
                    { value: 50, label: "Contracts Analyzed", suffix: "K+", decimals: 0 },
                    { value: 200, label: "Enterprise Clients", suffix: "+", decimals: 0 },
                  ].map((stat, i) => (
        ...
        {/* How It Works Section — sequential left-to-right */}
        ...
        {/* Testimonials Section — slide from different directions */}
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-8 lg:grid-cols-3">
              {pricingPlans.map((plan, i) => (
                <ScrollReveal key={plan.name} delay={i * 150} direction="scale">
                  <div
                    className={`relative rounded-2xl border p-8 backdrop-blur-md transition-all duration-300 cursor-pointer h-full
