...
export function useSubscription(): SubscriptionState & {
    ...
    upgradePlan: (plan: 'professional' | 'enterprise', billingPeriod: 'monthly' | 'annual', paymentMethod?: 'card' | 'crypto', txHash?: string) => Promise<void>;
} {
    const { user } = useAuth();
    ...
    const upgradePlan = async (
        ...
        if (txHash) {
            updateData.crypto_tx_hash = txHash;
        }
