...
import { Check, CreditCard, Loader2, Link2 } from "lucide-react";
    ...
    return (
        <>
            ...
            <CryptoPaymentDialog
                ...
                amountUsd={parseFloat(price.replace('$', ''))}
                planName={featureName}
                description={`Purchase ${featureName} with Ethereum`}
            />
        </>
    );
}
